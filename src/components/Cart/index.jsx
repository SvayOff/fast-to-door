            ...
            <div className="cart__products">
              ...
              <div className="cart__products-box">
                <div className="cart__product">
                  <img
                    className="cart__product-package"
                    src="./images/products/package.png"
                    alt="package"
                  />
                  <img
                    className="cart__product-union"
                  ...
                  <img
                    className="cart__product-fruit"
                    src="./images/products/product_8.png"
                    alt="product"
                  />
                  <h3 className="cart__product-title">Pineapple, 1 pc (1.2kg)</h3>
                  <div className="cart__product-info">
                    ...
                    <span className="cart__product-price">3.12 $</span>
                  </div>
                </div>
                <div className="cart__product">
                  <img
                  ...
                  <img
                    ...
                    alt="product"
                  />
                  <h3 className="cart__product-title">Pomelo, 1 pc (120g)</h3>
                  <div className="cart__product-info">
                    <div className="cart__product-counter">
                      <button type="button" className="cart__product-minus">
                        <svg
                    ...
                    <span className="cart__product-price">1.42 $</span>
                  </div>
                </div>
                <div className="cart__product">
                  <img
                  ...
                  <img
                    ...
                    alt="product"
                  />
                  <h3 className="cart__product-title">Mango, 1 pc (1kg)</h3>
                  <div className="cart__product-info">
                    <div className="cart__product-counter">
                      <button type="button" className="cart__product-minus">
                        <svg
                    ...
                    <span className="cart__product-price">3.25 $</span>
                  </div>
                </div>
                <div className="cart__product">
                  <img
                  ...
                  <img
                    ...
                    alt="product"
                  />
                  <h3 className="cart__product-title">Kivano, 1 pc (150g)</h3>
                  <div className="cart__product-info">
                    <div className="cart__product-counter">
                      <button type="button" className="cart__product-minus">
                        <svg
                    ...
                    <span className="cart__product-price">2 $</span>
                  </div>
                </div>
              </div>
            </div>
